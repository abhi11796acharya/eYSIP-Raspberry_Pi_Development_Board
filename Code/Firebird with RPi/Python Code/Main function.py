...
2. Current Implementation includes hardware test like Buzzer, DC motors with velocity control, Servo motors, Interrupt driven position encoder, BarLED, LCD,Sensors reading from both ATmega2560(master) and ATmega 8(slave) microcontroller.
...
while True:
        ...
        if y == '5':
                ...
                time.sleep(0.1)
                pi.adc_conversion(9)			# Channel No-9(Sharp sensor 1) of ATmega2560
                time.sleep(0.1)
                pi.adc_conversion(10)			# Channel No-10(Sharp sensor 2) of ATmega2560
                time.sleep(0.1)
                pi.adc_conversion(11)			# Channel No-11(Sharp sensor 3) of ATmega2560
                time.sleep(0.1)
                pi.adc_conversion(12)			# Channel No-12(Sharp sensor 4) of ATmega2560
                time.sleep(0.1)
                pi.adc_conversion(13)			# Channel No-13(Sharp sensor 5) of ATmega2560
                time.sleep(0.1)
        ...
        if y == '6':
                pi.lcd_disp("Firebird V 123")          # Prints on LCD
                time.sleep(1)
